...
if not on_rtd:
    ...
    feed_base_url = 'http://vsalm-hols.readthedocs.org/zh_CN/latest'
    feed_description = 'ALM HOLS Documentation'
    feed_author = 'DevOpsHub'
...
htmlhelp_basename = 'vsalm-hols-doc'
...
latex_documents = [
  ('index', 'vsalm-hols.tex', 'VSALM HOLS Documentation',
   'DevOpsHub', 'manual'),
]
...
man_pages = [
    ('index', 'vsalm-hols', 'VSALM HOLS Documentation',
     ['DevOpsHub'], 1)
]
...
texinfo_documents = [
  ('index', 'vsalm-hols', 'VSALM HOL Documentation',
   'DevOpsHub', 'vsalm-hols', 'VSALM HOL Documentation',
   'Visual Studio ALM'),
]
